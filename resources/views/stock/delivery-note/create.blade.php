...
<form method="post" action="/product">
    ...
    <div class="form-group row">
        ...
        <div  class="col-sm-2">
            ...
            <option value="Bahan Penolong">Penolong</option>
            </select>
        </div>
    </div>
    <div class="form-group row">
        <label for="category" class="col-sm-2 col-form-label">No. Pengeluaran</label>
        <div  class="col-sm-2">
    ...
    <div class="form-group row">
        <label for="code" class="col-sm-2 col-form-label">Tanggal Pengeluaran</label>
        <div  class="col-sm-2">
